...
* Designed for 4:3 displays (320×240)
* Stable 12–15 FPS playback
...
👉 **[https://links.terraintronics.com/ttinstall](https://links.terraintronics.com/ttinstall)**
...
> ⚠️ The ESP32 does **not** decode MP4 or H.264 video directly.
> All content must be converted to **MJPEG**.

---

## Video Conversion (MP4 → MJPEG)
...
The CYD display is **4:3 (320×240)**.
...
### Long Press (~5 seconds) — Display Inversion
